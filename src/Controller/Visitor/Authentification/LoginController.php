...
class LoginController extends AbstractController
{
    ...
    #[Route(path: '/register', name: 'visitor_authentification_register')]
    public function register(
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            try {
                ...
                return $this->redirectToRoute('visitor_authentification_register');
            }
        ...
        return $this->render('pages/visitor/authentification/register.html.twig', [
