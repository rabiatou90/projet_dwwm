...
class ResetPasswordController extends AbstractController
{
     ...
     */
    #[Route('', name: 'visitor_authentification_forgot_password_request', methods:['GET', 'POST'])]
     ...
     */
    #[Route('/check-email', name: 'visitor_authentification_check_email')]
    ...
    private function processSendingPasswordResetEmail(string $emailFormData, MailerInterface $mailer, TranslatorInterface $translator): RedirectResponse
    {
        ...
        if (!$user) 
        {
            return $this->redirectToRoute('visitor_authentification_check_email');
        }
        ...
        $email = (new TemplatedEmail())
            ...
            ->htmlTemplate('pages/visitor/authentification/reset_password/reset_password_email.html.twig')
            ->context([
                'resetToken' => $resetToken,
            ])
        ;
